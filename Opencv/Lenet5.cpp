...
#pragma omp parallel for
	...
	{
		Feature *features = (Feature *)calloc(GETCOUNT(Feature),sizeof(double));
		Feature *errors = (Feature *)calloc(GETCOUNT(Feature), sizeof(double));
		LeNet5	*deltas =(LeNet5 *)calloc(GETCOUNT(LeNet5),sizeof(double));
		/*Feature features = { 0 };
		Feature errors = { 0 };
		LeNet5	deltas = { 0 };*/
